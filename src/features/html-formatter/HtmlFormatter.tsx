      ...
      <div className="flex flex-wrap items-end gap-4">
        <label className="text-sm">
          ...
          <input
            ...
            className="w-24 rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
          />
        </label>
        <label className="text-sm">
